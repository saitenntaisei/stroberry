...
class Status {
 private:
  ...
  static constexpr parts::wheel<T, T> side_wall_sensor_ref = {11000, 9000};
  ...
  static constexpr std::uint32_t left_threshold = 3200, right_threshold = 2800, front_threshold = 4400;
  /* data */
 public:
