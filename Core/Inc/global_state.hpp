...
class GlobalState {
 public:
  ...
  static parts::wheel<pwm::Encoder<float, int16_t>, pwm::Encoder<float, int16_t>> enc;
  static parts::wheel<pwm::Motor, pwm::Motor> motor;
  static state::Controller<float, state::Status<float>, state::Pid<float>> ctrl;
  static adc::IrSensor<uint32_t> ir_sensor;
  static adc::Battery<float, uint32_t> batt;
...
adc::IrSensor<uint32_t> GlobalState::ir_sensor(&hadc2, 4, 160, 10);
adc::Battery<float, uint32_t> GlobalState::batt(&hadc1);
...
parts::wheel<pwm::Encoder<float, int16_t>, pwm::Encoder<float, int16_t>> GlobalState::enc = {pwm::Encoder<float, int16_t>(TIM1), pwm::Encoder<float, int16_t>(TIM8)};
